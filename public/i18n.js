...
(function (root) {
  ...
  const EN = {
    ...
    '화투 카드백': 'Hwatu Card Back',
    '붉은 등 · 화투짝을 엎어 놓은 뒷면': 'Red back — hanafuda cards laid face down',
    '화투 명패': 'Hwatu Plate',
    '붉은 판에 검은 테 · 골드 획득 +5%': 'Black on red · +5% gold',
    '화투 담요': 'Hwatu Blanket',
    '붉은 담요를 깔았다': 'A red blanket over the table',
    '화투 카드': 'Hwatu Faces',
    '숫자가 곧 월 — 2월 매조·3월 벚꽃·4월 흑싸리·6월 모란': 'The number is the month — Feb plum, Mar cherry, Apr bush clover, Jun peony',
    '새벽 카드백': 'Daybreak Card Back',
    '해 뜨기 직전의 남보라 — 첫 카드백으로': 'The violet just before sunrise — a first card back',
    '새벽 명패': 'Daybreak Plate',
    '트인 하늘빛 이름표 · 경험치 +2%': 'Open-sky nameplate · +2% XP',
    '새벽 테이블': 'Daybreak Table',
    '해 뜨기 전 하늘을 깐 판': 'A table the color of the sky before dawn',
    '밤하늘 이모트 팩': 'Night Sky Emote Pack',
    '달·별·수정 — 조용한 여덟 개': 'Moon, star, crystal — eight quiet ones',
    '행운 이모트 팩': 'Fortune Emote Pack',
    '네잎클로버·주사위·수정구 — 운을 비는 여덟 개': 'Clover, dice, crystal ball — eight for luck',
    '올빼미 아바타': 'Owl Avatar',
    '밤새 판을 읽는 눈': 'Eyes that read the table all night',
    '늑대 아바타': 'Wolf Avatar',
    '무리를 이끄는 쪽': 'The one that leads the pack',
    '불꽃 도장': 'Flame Stamp',
    '낙찰에 불도장을 찍는다': 'Brands the winning bid',
    '꽃잎': 'Petals',
    '카드를 낼 때 꽃잎이 흩날린다': 'Petals scatter as you play a card',
    '오로라 연출': 'Aurora Finish',
    '이기면 하늘에 오로라가 뜬다': 'An aurora rises when you win',
    '용린 카드백': 'Dragonscale Card Back',
    '비늘이 겹친 뒷면 · 파편으로만': 'Overlapping scales · shards only',
    '용린 명패': 'Dragonscale Plate',
    '비늘을 두른 이름표 · 코인 +6% · 파편으로만': 'Scaled nameplate · +6% coins · shards only',
    '용린 테이블': 'Dragonscale Table',
    '용이 서린 판 · 파편으로만': 'A dragon coiled across the table · shards only',
    '용린 카드': 'Dragonscale Faces',
    '비늘무늬 숫자 앞면 · 파편으로만': 'Numbers on scales · shards only',
    '파도 카드백': 'Tide Card Back',
    '밤바다 물결이 이는 카드 뒷면': 'Night waves rolling across the back',
    '파도 명패': 'Tide Plate',
    '물결이 흐르는 명패': 'A nameplate with water running through it',
    '심해 테이블': 'Deep Sea Table',
    '깊은 바다빛 테이블': 'A table in deep-ocean blue',
    '물결 카드': 'Tide Faces',
    '숫자가 물빛으로 일렁이는 카드 앞면': 'Numbers rippling like water',
    '서리 카드백': 'Frost Card Back',
    '성에가 낀 유리 같은 카드 뒷면': 'A back like frosted glass',
    '서리 명패': 'Frost Plate',
    '서리가 앉은 명패': 'A nameplate touched with frost',
    '빙판 테이블': 'Ice Table',
    '얼어붙은 호수 같은 테이블': 'A table like a frozen lake',
    '서리 카드': 'Frost Faces',
    '숫자에 성에가 앉은 카드 앞면': 'Numbers rimed with frost',
    '자개 카드백': 'Nacre Card Back',
    '빛에 따라 색이 도는 자개 카드 뒷면': 'Mother-of-pearl that shifts with the light',
    '자개 명패': 'Nacre Plate',
    '옻칠에 자개를 박은 명패': 'Nacre inlaid in lacquer',
    '자개 테이블': 'Nacre Table',
    '자개를 박은 옻칠 테이블': 'A lacquered table inlaid with nacre',
    '청사초롱 카드백': 'Lantern Card Back',
    '청사초롱 불빛이 어린 카드 뒷면': 'Lit by a blue-and-red lantern',
    '초롱 테이블': 'Lantern Table',
    '초롱불이 걸린 밤 테이블': 'A night table hung with lanterns',
    '호랑이 탈': 'Tiger Mask',
    '탈춤 속 호랑이 탈': 'The tiger of the mask dance',
    '학': 'Crane',
    '고고한 학 한 마리': 'One crane, standing apart',
    '도깨비': 'Dokkaebi',
    '뿔 달린 도깨비 — 방망이는 안 줍니다': 'A horned dokkaebi — the club is not included',
    '꽃보라': 'Blossom Storm',
    '이기면 벚꽃이 화면을 덮어요': 'Cherry blossoms fill the screen when you win',
    '반딧불': 'Fireflies',
    '이기면 반딧불이 떠올라요': 'Fireflies rise when you win',
    '매화 도장': 'Plum Stamp',
    '낙찰 카드에 매화 도장': 'A plum-blossom seal on the card you win',
    '먹 도장': 'Ink Stamp',
    '낙찰 카드에 먹으로 찍은 도장': 'An ink seal on the card you win',
    '뇌우 카드백': 'Storm Card Back',
    '먹구름 사이로 번개가 지나는 뒷면': 'Lightning through heavy cloud',
    '뇌우 명패': 'Storm Plate',
    '번개가 스치는 먹구름 명패': 'A stormcloud nameplate, lightning across it',
    '뇌우 테이블': 'Storm Table',
    '번개가 치는 밤 테이블': 'A night table under lightning',
    '뇌우 앞면': 'Storm Faces',
    '숫자에 번개가 스치는 앞면': 'Lightning across the numbers',
    '색종이 카드백': 'Origami Card Back',
    '접은 자국이 남은 색종이 뒷면': 'Coloured paper, creases still showing',
    '색종이 앞면': 'Origami Faces',
    '숫자가 접힌 종이처럼 꺾인 앞면': 'Numbers folded like paper',
    '종이학 도장': 'Paper Crane Stamp',
    '낙찰 카드에 종이학 도장': 'A paper-crane seal on the card you win',
    '젤리 카드백': 'Jelly Card Back',
    '말랑한 젤리 같은 뒷면': 'A back as soft as jelly',
    '젤리 테이블': 'Jelly Table',
    '젤리를 부어 굳힌 테이블': 'A table poured and set like jelly',
    '곰젤리': 'Gummy Bear',
    '한 입 크기 곰젤리': 'One bite of gummy bear',
    '도트 카드백': 'Pixel Card Back',
    '옛 오락실 도트 뒷면': 'Old arcade pixels',
    '도트 앞면': 'Pixel Faces',
    '숫자가 픽셀로 찍힌 앞면': 'Numbers punched out in pixels',
    '도트 명패': 'Pixel Plate',
    '픽셀로 찍은 명패': 'A nameplate in pixels',
    '도트 고양이': 'Pixel Cat',
    '픽셀로 찍은 고양이': 'A cat in pixels',
    '불꽃 테이블': 'Firework Table',
    '불꽃이 터지는 밤하늘 테이블': 'A table under bursting fireworks',
    '불꽃 명패': 'Firework Plate',
    '불꽃이 터지는 밤하늘 명패': 'A nameplate under bursting fireworks',
    '쾅! 놓기': 'Slam',
    '카드를 도장 찍듯 쾅 내려놓아요': 'You bring the card down like a stamp',
    '물결 놓기': 'Ripple',
    '카드를 놓으면 물결이 퍼져요': 'A ripple spreads where the card lands',
    '해태': 'Haetae',
    '불을 먹는다는 짐승, 해태': 'The haetae, said to eat fire',
    '해태 카드백': 'Haetae Card Back',
    ...
    '보너스 코인': 'Bonus Coins',
    '보상 받기': 'Claim',
    '광고 보고 받기': 'Watch ad & claim',
    '받는 중…': 'Claiming...',
    '광고 보는 중…': 'Watching ad...',
    '오늘 그냥 드리는 보너스예요.': 'A free bonus, on us.',
    '로그인하면 받을 수 있어요.': 'Sign in to claim.',
    ...
    '— 손패에서 배팅할 카드를 고르세요!': '\u2014 pick your bid card from your hand!',
    ...
    '이번 경매품이 상대에게 얼마나 쓸모 있는지 본다': 'See how useful this lot is to the opponent',
    '이번 경매품을 상대에게만 가린다': 'Hide this lot from the opponent only',
    '내가 딴 카드 1장과 상대가 딴 카드 1장을 맞바꾼다': 'Swap 1 of your won cards with 1 of theirs',
    '경매품에 폭탄을 얹는다 — 낙찰받은 쪽이 손패 1장을 버린다': 'Rig the lot \u2014 whoever wins it discards a card',
    ...
    '덱 맨 위 3장을 보고 그중 하나를 이번 중앙 카드로 고른다': 'Look at the top 3 and pick one as the centre card',

    '상대가 낙찰받은 카드 1장을 덱으로 되돌린다': 'Send 1 card the opponent won back to the deck',
    '이번 턴 진행자 권한을 뺏는다': 'Seize the auctioneer role for this turn',

    '경매를 다시 한다 — 방금 낸 카드는 둘 다 못 쓴다!': 'Auction again \u2014 neither can reuse that card!',
    '덱을 훑어 원하는 카드를 골랐다!': 'Combed the deck and picked the one you wanted!',
    '경매품에 폭탄을 얹었다 — 먹는 쪽이 손해!': 'Bomb on the lot \u2014 winning it costs you!',
    '전리품을 맞바꿨다!': 'Swapped the spoils!',
    '상대의 시야를 가렸다!': "Blocked the opponent's view!",
    '상대의 전리품을 덱으로 돌려보냈다!': "Sent the opponent's prize back to the deck!",
    '아직 경매가 안 열렸어요.': 'The auction has not opened yet.',
    '이미 폭탄이 얹혀 있어요.': 'A bomb is already on the lot.',
    '서로 딴 카드가 있어야 해요.': 'Both sides need won cards for this.',
    '방금 낸 카드는 다시 낼 수 없어요.': 'You cannot play that card again.',
    '상대에겐 별 쓸모가 없다': 'Not much use to them',
    '상대에게 쓸 만하다': 'Useful to them',
    '상대가 간절히 원한다': 'They want it badly',
    ...
    '상대가 방식을 고르는 중…': 'Opponent is choosing the auction type…',
    '상대가 내놓는 중…': 'Opponent is offering a card…',
    '상대가 카드를 뽑는 중…': 'Opponent is drawing a card…',
    '배팅 완료 — 상대를 기다립니다…': 'Bid submitted — waiting for your opponent…',
    '카드 정산 중…': 'Settling cards...',
    '중앙 카드 공개 — 내놓을 카드를 고르세요': 'Center card revealed — pick a card to offer',
    '경매 방식을 고르세요 — 출품 카드는 다른 손패를 탭하면 바뀝니다': 'Choose the auction type — tap another card to swap your offer',
    ...
    '\ud83c\udca0 중앙덱을 탭해 카드를 뽑으세요': '\ud83c\udca0 Tap the deck to draw a card',
  ...
  const PATTERNS = [
    ...
    [/^\uad6c\ub9e4 \ud83d\udd37 ([\d,]+)$/, 'Buy \ud83d\udd37 $1'],
    [/^시즌 (\d+)$/, 'Season $1'],
    [/^무료 \ud83e\ude99 \+(\d+) — 오늘 (\d+)번 남음$/, 'Free \ud83e\ude99 +$1 \u2014 $2 left today'],
    [/^광고 보고 \ud83e\ude99 \+(\d+) — 오늘 (\d+)번 남음$/, 'Watch an ad \ud83e\ude99 +$1 \u2014 $2 left today'],
    [/^오늘 (\d+)번 남음 · 하루 (\d+)번$/, '$1 left today \u00b7 $2 per day'],
    [/^광고를 (\d+)초 이상 보면 코인을 받아요\.$/, 'Watch at least $1s of an ad to get coins.'],
    [/^\ud83e\ude99 (\d+) 받았어요!$/, '\ud83e\ude99 $1 claimed!'],
    [/^(\d+)개 · 누르면 그 자리에서 확정으로 바뀝니다$/, '$1 \u00b7 tap to convert on the spot'],
    ...
    [/^\u{1F441} 오픈\(배팅 비밀\) — 손패에서 배팅할 카드를 고르세요!$/u, '\u{1F441} Open (bids hidden) — pick your bid card!'],
    [/^\u{1F648} 클로즈\(배팅 공개\) — 손패에서 배팅할 카드를 고르세요!$/u, '\u{1F648} Closed (bids shown) — pick your bid card!'],
    [/^내 배팅 \u2713$/, 'Your bid \u2713'],
    [/^상대 배팅 \u2713$/, 'Opponent bid \u2713'],
    [/^(.+) 배팅 \u2713$/, '$1 bid \u2713'],
    [/^(.+) 배팅$/, '$1 bid'],
  ...
  const BLOCKS = {
    ...
    <h2>More</h2>
    <p class="r-lead">Ranks, RP, levels and rewards \u2014 all in one place.</p>
    ...
    <p class="r-note">ACE holds only 100 seats, so places change hands by RP ranking.
    ...
    <p class="r-note">Multiplayer games settle by placement \u2014 1st +25, 2nd +8, 3rd \u22128, 4th \u221222.</p>
    ...
    <p class="r-note">Founding a clan needs <b>level 5</b> and <b>\ud83e\ude99 1,000</b>.</p>
    ...
    <p class="r-note">Games that end too quickly (under 5 turns or 30 seconds) pay nothing.
...
`,
    ...
    rulesItem: `
      ...
      <h2>Item Match</h2>
      <p class="r-lead">The 2-player rules are untouched. <b style="color:#ffe9a8">Items</b> are laid on top \u2014
      ...
      <p class="r-note">Re-auction alone is limited to <b>the player who lost that auction</b> \u2014
      ...
      <p class="r-note">A ward cannot block a ward \u2014 otherwise whoever placed one first would always win the exchange.
    ...
    rulesTwelve: `
      <span class="close-x" onclick="rulesClose()">\u00d7</span>
      <h2>TWELVE</h2>
      <p class="r-lead">The cards are exactly those of Classic. What changes is <b style="color:#ffe9a8">what you pay with</b> \u2014
      ...
      <p class="r-note">The auctioneer spends one card from hand every turn, so six cards means <b>six turns running the auction</b>.</p>
      ...
      <p class="r-note">The opening bid must be <b>at least 1</b>, and you cannot step back while nothing is staked \u2014
      ...
      <p class="r-note">With fewer than 2 chips the auctioneer cannot choose Closed \u2014 there is no even number to name.
      ...
      <p class="r-note"><b>Example:</b> bid 7 and win, you pay 7. Follow to 4 and step back, you pay 2.</p>
      ...
      <p class="r-note">As in Classic, each player has <b>five minutes</b>. Your clock runs only on your turn, and running out loses.</p>
      <p class="r-note">The AI comes in three grades. Expert counts the unseen cards, never spends its last chip,
         and uses closed auctions to drain yours.</p>
      <p class="r-note">TWELVE does not affect your rank (RP) \u2014 only coins and experience.</p>`,
    // 미니게임 설명서 — 영어판. 본 게임과 규칙이 달라 따로 둔다.
    // 미니게임 설명서 — 영어판. 본 게임과 규칙이 달라 따로 둔다.
    rulesMini: `
    <span class="close-x" onclick="toggleRulesMini(false)">\u00d7</span>
    <h2>Two-Card Duel</h2>
    <p class="r-lead">2\u20134 players. A Sutda-style mini game: take two cards, keep them <b style="color:#ffe9a8">hidden</b>, and bet.</p>
    ...
    <p class="r-note">Because betrayal inverts the order, with three or more still in
    ...
    <h2>FLIP FLAP</h2>
    <p class="r-lead">Win auctions, collect cards, and be the first to complete a <b style="color:#ffe9a8">set</b>.</p>
    ...
    <h3><span data-ico="\ud83d\uddc2"></span> The deck <span class="r-sub">\u2014 24 cards</span></h3>
    <div class="r-comp">
    ...
    <p class="r-note"><b style="color:#ffe9a8">The commoner the kind, the longer its set.</b>
    ...
    <p class="r-note">Only the auctioneer chooses. Either way, <b>something has to be shown</b>.</p>
    <div class="r-two">
